...
namespace Input
{
    ...
    public:
        ...
        MouseDevice();
          ...
          */
        ButtonState GetButtonState(MouseButton button, const Conure::Utility::TimeSpan& timeSpan) const;
         ...
         */
        float VerticalWheelDiff(const Conure::Utility::TimeSpan& timeSpan) const final;
         ...
         */
        float HorizontalWheelDiff(const Conure::Utility::TimeSpan& timeSpan) const final;
