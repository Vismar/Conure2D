...
namespace Input
{
    ...
    public:
        ...
        MouseDevice();
          ...
          */
        ButtonState GetButtonState(MouseButton button, const Utility::TimeSpan& timeSpan) const;
         ...
         */
        float VerticalWheelDiff(const Utility::TimeSpan& timeSpan) const final;
         ...
         */
        float HorizontalWheelDiff(const Utility::TimeSpan& timeSpan) const final;
